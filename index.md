...
<p>Explored traffic scene segmentation using CNNs. Trained models were compressed using TensorFlow Lite (Float16, Int8) achieving 91% size reduction for embedded deployment.</p>
...
<p>Comprehensive study of variational methods for scene flow estimation. Classified methods based on energy formulation and assessed optimization algorithms against ground truth.</p>
<div class="project-meta">
<div class="tags">
...
<p>Trajectory tracking for road rollers. Implemented edge spline extraction and behavior-based control strategies for precise maneuvering in ROS/Finroc.</p>
...
<p>Decentralized formation control using graph theory. Coordinated four unicycle robots to maintain formation using consensus algorithms in MATLAB.</p>
